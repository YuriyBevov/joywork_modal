<template>
    <div class="modal" @click="closeModalByOverlayClick">
        <div class="modal__container" 
            @click="closeModalByOverlayClick" 
            @scroll="onScrollHandler"
            :style="isAverageModalOpened ? 'overflow: hidden' : 'overflow: auto'"
        >
            <div class="modal__header">
                <h2 class="modal__title">{{modalTitle}}</h2>

                <button type="button" @click="closeModal" class="modal__close btn-default">
                    <svg width="18" height="18">
                        <use xlink:href="#icon-close"></use>
                    </svg>
                </button>
            </div>
            {{isAverageModalOpened}}
            ...
            <div class="modal__content">
                                                ...
                                                <div>
                                                    ...
                                                    <div class='range'>
                                                        <div class="range__body">
                                                            ...
                                                            <div class="range__thumb range__thumb--left" tabindex="0" ></div>
                                                            <div class="range__thumb range__thumb--right" tabindex="0" ></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                ...
                <div 
                    class="inner-modal average-modal" 
                    v-if="isAverageModalOpened"
                    :style="'top:' + modalScrollPos + 'px'"
                    @click="closeModalByOverlayClick" 
                >
                    <div class="inner-modal__container average-modal__container">
                        <div class="inner-modal__header">
                            ...
                            <button type="button" @click="isAverageModalOpened = false" class="inner-modal__close btn-default">
                                <svg width="18" height="18">
                                    <use xlink:href="#icon-close"></use>
                                </svg>
                            </button>
    ...
    export default {
        ...
        methods: {
            closeModalByOverlayClick(evt) {
                ...
                const innerOverlay = document.querySelector('.inner-modal');

                let container = document.querySelector('.analitics-modal-container');
            ...
            onScrollHandler(evt) {
                this.modalScrollPos = evt.target.scrollTop;
            }
        },
        ...
        watch: {
            isModalOpened: function(oldVal, newVal) {
                ...
                console.log(this.isAverageModalOpened)
            },
        }
    }
</script>